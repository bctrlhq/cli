...
export const CLI_HELP_COMMANDS = {
    ...
    output: {
      fields: [
        ...
        },
        {
          ...
          type: "ready | verification_required",
          required: true,
          values: ["ready", "verification_required"],
        },
        {
          name: "version",
          type: "string",
  ...
  "conversations.create": {
    ...
    api: {
      ...
      requestFields: ["runtimeId", "model", "toolsetId", "title"],
      responseFields: [
        "activeTurnId",
        "createdAt",
        "id",
  ...
  "conversations.update": {
    ...
    api: {
      ...
      requestFields: ["model", "toolsetId", "title"],
      responseFields: [
        "activeTurnId",
        "createdAt",
        "id",
  ...
  "runs.events.list": {
    ...
    inputs: {
      ...
      query: [
        ...
        {
          name: "source",
          type: "browser | network | runtime | agent | tool | system[]",
          required: false,
          description:
      ...
      fields: [
        {
          ...
          type: "null | string",
          required: true,
          description: "Unique toolRevision identifier generated by BCTRL.",
        },
        {
          name: "description",
          type: "string",
